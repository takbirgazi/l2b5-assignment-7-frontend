...
export default function SingleBlogPage() {
    ...
    const loadBlog = async () => {
        setIsLoading(true)
        const response = await fetchBlogBySlug(params.slug as string)
        if (response) {
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="font-semibold text-lg mb-2">
                                    Written by {blog.author?.name || 'Takbir Gazi'}
                                </h3>
                                <p className="text-muted-foreground mb-4">
                                    Passionate web developer sharing insights about modern web technologies,
